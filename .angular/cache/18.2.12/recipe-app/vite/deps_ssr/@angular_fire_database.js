...
var require_headers = __commonJS({
  "node_modules/websocket-driver/lib/websocket/driver/headers.js"(exports, module) {
    ...
    Headers.prototype.set = function(name3, value) {
      ...
      name3 = this._strip(name3);
      value = this._strip(value);
      var key = name3.toLowerCase();
      if (!this._sent.hasOwnProperty(key) || this.ALLOWED_DUPLICATES.indexOf(key) >= 0) {
        this._sent[key] = true;
        this._lines.push(name3 + ": " + value + "\r\n");
      }
    };
    ...
    var instance = {
      ...
      _bindEventListeners: function() {
        ...
        this.on("error", function(error3) {
          var messages = self.messages;
          if (messages.readable) messages.emit("error", error3);
        });
      ...
      setHeader: function(name3, value) {
        if (this.readyState > 0) return false;
        this._headers.set(name3, value);
        return true;
      },
      start: function() {
        if (this.readyState !== 0) return false;
...
var require_http_parser = __commonJS({
  "node_modules/http-parser-js/http-parser.js"(exports) {
    ...
    function HTTPParser(type) {
      assert3.ok(type === HTTPParser.REQUEST || type === HTTPParser.RESPONSE || type === void 0);
      if (type === void 0) {
      } else {
    ...
    HTTPParser.prototype.initialize = function(type, async_resource) {
      assert3.ok(type === HTTPParser.REQUEST || type === HTTPParser.RESPONSE);
      this.type = type;
    ...
    ["Headers", "HeadersComplete", "Body", "MessageComplete"].forEach(function(name3) {
      var k = HTTPParser["kOn" + name3];
      Object.defineProperty(HTTPParser.prototype, "on" + name3, {
        get: function() {
          return this[k];
        },
        set: function(to) {
...
var require_http_parser2 = __commonJS({
  "node_modules/websocket-driver/lib/websocket/http_parser.js"(exports, module) {
    ...
    var VERSION2 = process.version ? process.version.match(/[0-9]+/g).map(function(n) {
      return parseInt(n, 10);
    }) : [];
    if (VERSION2[0] === 0 && VERSION2[1] === 12) {
...
var require_parser = __commonJS({
  "node_modules/websocket-extensions/lib/parser.js"(exports, module) {
    ...
    var Parser = {
      parseHeader: function(header) {
        ...
        values.forEach(function(value) {
          var params = value.match(new RegExp(PARAM.source, "g")), name3 = params.shift(), offer = {};
          ...
          offers.push(name3, offer);
        }, this);
        return offers;
      },
      serializeParams: function(name3, params) {
        var values = [];
        ...
        return [name3].concat(values).join("; ");
      }
    };
    var Offers = function() {
      this._byName = {};
    ...
    Offers.prototype.push = function(name3, params) {
      if (!hasOwnProperty.call(this._byName, name3)) this._byName[name3] = [];
      this._byName[name3].push(params);
      this._inOrder.push({
        name: name3,
        params
      });
    ...
    Offers.prototype.eachOffer = function(callback, context) {
      var list3 = this._inOrder;
      for (var i = 0, n = list3.length; i < n; i++) callback.call(context, list3[i].name, list3[i].params);
    };
    Offers.prototype.byName = function(name3) {
      return this._byName[name3] || [];
    };
...
var require_pledge = __commonJS({
  "node_modules/websocket-extensions/lib/pipeline/pledge.js"(exports, module) {
    ...
    Pledge.QUEUE_SIZE = 4;
    Pledge.all = function(list3) {
      var pledge = new Pledge(), pending = list3.length, n = pending;
      if (pending === 0) pledge.done();
      while (n--) list3[n].then(function() {
        pending -= 1;
        if (pending === 0) pledge.done();
      });
      return pledge;
...
var require_pipeline = __commonJS({
  "node_modules/websocket-extensions/lib/pipeline/index.js"(exports, module) {
    ...
    Pipeline.prototype._loop = function(direction, start, end, step, message, callback, context) {
      ...
      var pipe = function(index, error3, msg) {
        if (index === end) return callback.call(context, error3, msg);
        cells[index][direction](error3, msg, function(err, m) {
    ...
    var instance = {
      ...
      generateOffer: function() {
        ...
        this._inOrder.forEach(function(ext) {
          ...
          offers.forEach(function(off4) {
            offer.push(Parser.serializeParams(ext.name, off4));
          }, this);
        }, this);
      ...
      activate: function(header) {
        ...
        responses.eachOffer(function(name3, params) {
          var record = this._index[name3];
          if (!record) throw new Error('Server sent an extension response for unknown extension "' + name3 + '"');
          ...
          if (session.activate(params) !== true) throw new Error("Server sent unacceptable extension parameters: " + Parser.serializeParams(name3, params));
          this._reserve(ext);
          sessions.push(record);
        }, this);
        this._sessions = sessions;
...
var require_hybi = __commonJS({
  "node_modules/websocket-driver/lib/websocket/driver/hybi.js"(exports, module) {
    ...
    Hybi.generateAccept = function(key2) {
      var sha13 = crypto.createHash("sha1");
      sha13.update(key2 + Hybi.GUID);
      return sha13.digest("base64");
    };
    ...
    var instance = {
      ...
      frame: function(buffer, type, code) {
        ...
        if (this.MESSAGE_OPCODES.indexOf(message.opcode) >= 0) this._extensions.processOutgoingMessage(message, function(error3, message2) {
          if (error3) return this._fail("extension_error", error3.message);
      ...
      _handshakeResponse: function() {
        ...
        if (version3 !== Hybi.VERSION) throw new Error("Unsupported WebSocket version: " + version3);
      ...
      _shutdown: function(code, reason, error3) {
        ...
        this._extensions.close(function() {
          ...
          this.readyState = 3;
          if (error3) this.emit("error", new Error(reason));
          this.emit("close", new Base.CloseEvent(code, reason));
        }, this);
      },
      _fail: function(type, message) {
...
var require_server = __commonJS({
  "node_modules/websocket-driver/lib/websocket/driver/server.js"(exports, module) {
    ...
    Server.http = function(request, options) {
      ...
      var headers = request.headers, version3 = headers["sec-websocket-version"], key2 = headers["sec-websocket-key"], key1 = headers["sec-websocket-key1"], key22 = headers["sec-websocket-key2"], url = this.determineUrl(request);
      if (version3 || key2) return new Hybi(request, url, options);
...
var require_api = __commonJS({
  "node_modules/faye-websocket/lib/faye/websocket/api.js"(exports, module) {
    ...
    var API = function(options) {
      ...
      if (headers) {
        for (var name3 in headers) this._driver.setHeader(name3, headers[name3]);
      }
      ...
      this._driver.on("error", function(error3) {
        self._emitError(error3.message);
      });
      this.on("error", function() {
      });
    ...
    var instance = {
      ...
      _configureStream: function() {
        ...
        this._stream.on("error", function(error3) {
          self._emitError("Network error: " + self.url + ": " + error3.message);
          self._finalizeClose();
        });
      },
      _open: function() {
...
var require_client2 = __commonJS({
  "node_modules/faye-websocket/lib/faye/websocket/client.js"(exports, module) {
    ...
    Client.prototype._configureProxy = function(proxy, originTLS) {
      var uri = url.parse(this.url), secure = SECURE_PROTOCOLS.indexOf(uri.protocol) >= 0, self = this, name3;
      this._proxy = this._driver.proxy(proxy.origin);
      if (proxy.headers) {
        for (name3 in proxy.headers) this._proxy.setHeader(name3, proxy.headers[name3]);
      }
      ...
      this._proxy.on("connect", function() {
        if (secure) {
          ...
          for (name3 in originTLS) options[name3] = originTLS[name3];
      ...
      this._proxy.on("error", function(error3) {
        self._driver.emit("error", error3);
      });
    };
    module.exports = Client;
  }
...
var import_faye_websocket = __toESM(require_websocket());
...
function repoPruneCompletedTransactionsBelowNode(repo, node) {
  ...
  if (queue) {
    let to = 0;
    for (let from3 = 0; from3 < queue.length; from3++) {
      if (queue[from3].status !== 2) {
        queue[to] = queue[from3];
        to++;
      }
    }
    queue.length = to;
...
function objectVal(query3, options) {
  ...
  return fromRef(query3, ListenEvent.value).pipe((0, import_operators.map)(function(change) {
...
function stateChanges(query3, options) {
  ...
  return import_rxjs.merge.apply(void 0, childEvent$);
}
function get2(query3) {
  return (0, import_rxjs.from)(get(query3)).pipe((0, import_operators.map)(function(snapshot) {
...
function list(query3, options) {
  ...
  var events = validateEventsArray(options.events);
  return get2(query3).pipe((0, import_operators.switchMap)(function(change) {
    var childEvent$ = [(0, import_rxjs.of)(change)];
    events.forEach(function(event) {
      childEvent$.push(fromRef(query3, event));
    });
    return import_rxjs.merge.apply(void 0, childEvent$).pipe((0, import_operators.scan)(buildView, []));
...
function listVal(query3, options) {
  ...
  return list(query3).pipe((0, import_operators.map)(function(arr) {
...
function auditTrail(query3, options) {
  ...
  var auditTrail$ = stateChanges(query3, options).pipe((0, import_operators.scan)(function(current, changes) {
...
function loadedData(query3) {
  return fromRef(query3, ListenEvent.value).pipe((0, import_operators.map)(function(data) {
    var lastKeyToLoad;
...
function waitForLoaded(query3, snap$) {
  ...
  return loaded$.pipe(
    (0, import_operators.withLatestFrom)(snap$),
    // Get the latest values from the "loaded" and "child" datasets
    // We can use both datasets to form an array of the latest values.
    (0, import_operators.map)(function(_a2) {
    ...
    (0, import_operators.skipWhile)(function(meta) {
      return meta.loadedKeys.indexOf(meta.lastKeyToLoad) === -1;
    }),
    // Pluck off the meta data because the user only cares
    // to iterate through the snapshots
    (0, import_operators.map)(function(meta) {
      return meta.changes;
    })
  );
}

// node_modules/@angular/fire/node_modules/@firebase/database/dist/node-esm/index.node.esm.js
var import_faye_websocket2 = __toESM(require_websocket());
...
function setWebSocketImpl2(impl) {
  WebSocketImpl2 = impl;
}
...
var IndexMap2 = class _IndexMap {
  ...
  static get Default() {
    ...
    _defaultIndexMap2 = _defaultIndexMap2 || new _IndexMap({
      ".priority": fallbackObject2
    }, {
      ".priority": PRIORITY_INDEX2
    });
...
function nodeFromJSON2(json, priority = null) {
  ...
  if (!(json instanceof Array) && USE_HINZE2) {
    ...
    if (childrenHavePriority) {
      ...
      return new ChildrenNode2(childSet, nodeFromJSON2(priority), new IndexMap2({
        ".priority": sortedChildSet
      }, {
        ".priority": PRIORITY_INDEX2
      }));
...
function repoManagerDatabaseFromApp2(app, authProvider, appCheckProvider, url, nodeAdmin) {
  ...
  const repo = repoManagerCreateRepo2(repoInfo, app, authTokenProvider, new AppCheckTokenProvider2(app.name, appCheckProvider));
...
function connectDatabaseEmulator(db, host, port, options = {}) {
  ...
  if (db._instanceStarted) {
    fatal2("Cannot call useEmulator() after instance has already been initialized.");
  }
...
setWebSocketImpl2(import_faye_websocket2.default.Client);
registerDatabase2("node");
...
var databaseInstance$ = (0, import_rxjs2.timer)(0, 300).pipe((0, import_operators2.concatMap)(() => (0, import_rxjs2.from)(ɵgetAllInstancesOf(DATABASE_PROVIDER_NAME))), (0, import_operators2.distinct)());
...
var child3 = ɵzoneWrap(child2, true);
...
@firebase/database/dist/node-esm/index.node.esm.js:
  (**
   * @license
